...
var M = {
  ...
  settings: {
	...
	init: function () {
		M.c = document.getElementById( 'matrix-rain' );
	...
	createCanvii: function(i) {
		...
		for (var j = 1; j < codeLen; j++) {
			...
			if (j < 5) {
				newCtx.shadowColor = 'rgb(102,51,153)';
				newCtx.shadowOffsetX = 0;
				newCtx.shadowOffsetY = 0;
				newCtx.shadowBlur = 10;
				newCtx.fillStyle = 'rgba(102,51,153,0.3)';
			} else if (j > (codeLen - 4)) {
				...
				newCtx.shadowOffsetY = 0;
				newCtx.shadowBlur = 0;
				newCtx.fillStyle = 'rgba(102,51,153,0.9)';
			} else {
				newCtx.shadowOffsetX = 0;
				newCtx.shadowOffsetY = 0;
				newCtx.shadowBlur = 0;
				newCtx.fillStyle = 'rgba(102,51,153,0.6)';
			}
